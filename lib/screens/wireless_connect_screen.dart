...
class _WirelessConnectScreenState extends State<WirelessConnectScreen> {
        ...
        children: groupedDevices.map((d) {
          ...
          return SimpleDialogOption(
            onPressed: () {
              ...
              if (pairPort != null) {
                _pairPortController.text = pairPort;
              }
              if (connectPort != null) {
                _connectPortController.text = connectPort;
              }
              Navigator.pop(ctx);
            },
            child: Padding(
  ...
  void _showPairViaUsbDialog() {
    ...
    final usbDevices = provider.devices
        .where((d) => d.transport == 'usb')
        .toList();
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: const Column(
            ...
            children: [
              ...
              SizedBox(height: 12),
              Text(
                "1. Enable Developer Mode on your Peloton\n"
              ...
              SizedBox(height: 8),
              Text(
                "4. Accept the \"Allow USB debugging\" prompt on the Peloton",
              ),
              SizedBox(height: 8),
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              "Setting up wireless ADB on ${device.name ?? device.serial}...\n\n"
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            "Enter the IP address, pairing code, and ports from the Wireless Debugging screen on your Peloton.",
          ),
          const SizedBox(height: 20),
            ...
            builder: (context, provider, _) {
              ...
              for (final device in provider.devices) {
                ...
                if (device.transport == 'wifi' && device.ip != null) {
                  grouped[name]!.add(
                    'WiFi (${device.ip}${device.port != null ? ':${device.port}' : ''})',
                  );
                } else {
