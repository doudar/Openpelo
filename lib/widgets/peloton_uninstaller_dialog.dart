...
class PelotonUninstallerDialog extends StatefulWidget {
  ...
  @override
  State<PelotonUninstallerDialog> createState() =>
      _PelotonUninstallerDialogState();
}
...
class _PelotonUninstallerDialogState extends State<PelotonUninstallerDialog> {
  ...
  void _confirmAndUninstall() async {
    ...
    if (confirm == true && mounted) {
      ...
      await provider.uninstallPelotonPackages(_selected.toList());
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "Uninstalling core Peloton system applications may render your tablet completely UNUSABLE (brick it).",
            ...
            Expanded(
              child: _loading
                  ...
                  ? const Center(
                      child: Text(
                        "No Peloton packages found matching criteria.",
                      ),
                    )
                  : ListView.builder(
